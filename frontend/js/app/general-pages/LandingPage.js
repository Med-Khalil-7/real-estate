            ...
            <div className="row">
              <div className="col-md-12">
                <nav className="navbar navbar-expand-lg">
                  <a className="navbar-brand" href="!#" onClick={event => event.preventDefault()}><img src={ require( "../../assets/images/logo3.png") } alt="logo" /></a>
            ...
            <div className="container">
              <div className="row">
                <div className="col-lg-4">
                  <img className="img-fluid" src={ require( "../../assets/images/logo3.png")} alt="logo" />
