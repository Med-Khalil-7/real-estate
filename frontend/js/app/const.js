...
export const PRIORITY_1 = { value: 'H', label: 'High' };
export const PRIORITY_2 = { value: 'M', label: 'Medium' };
export const PRIORITY_3 = { value: 'L', label: 'Low' };
...
export const MD_EDITOR_PLUGINS = ['header', 'fonts', 'table', 'link', 'mode-toggle', 'full-screen'];
