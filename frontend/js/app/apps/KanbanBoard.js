            ...
            <ul id="portlet-card-list-1" className="portlet-card-list">
              <li className="portlet-card">
                ...
                <div className="d-flex justify-content-between">
                  <div
                    className={"badge badge-inverse-" + this.props.task.badgeVariant}>{this.props.task.priority}</div>
      ...
      <div>
        <div className="d-flex flex-column flex-md-row align-items-center flex-wrap pb-5">
          ...
          <div className="wrapper d-flex align-items-center">
            ...
            <button type="button" className="btn btn-outline-secondary px-5 ml-4"><i className="mdi mdi-lock mr-2"></i>Private
            </button>
          </div>
