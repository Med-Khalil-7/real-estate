  ...
  return (
    ...
    <div>
      <div className="page-header">
        <h3 className="page-title">{t("Apartments")}</h3>
      </div>
      <div className="row">
                ...
                <div id="general-info" className="form-row">
                  ...
                  <div className="form-group col-md-4">
                    ...
                    <Typeahead
                      ...
                      valueKey="id"
                      placeholder="tower"
                      defaultSelected={_.filter(towers, {id: getValues("apartment.tower")})}
                      onChange={(selected) => {
                        selected.length !== 0 ? setValue("apartment.tower", selected[0].id) : setValue("apartment.tower", null);
                      }}
                      options={towers}
                    />
                  </div>
                ...
                <div className="form-row">
                  ...
                  <div className="form-group col-md-6">
                    ...
                    <input
                      ...
                      className={`form-control ${errors && errors?.apartment?.number ? "is-invalid" : ""}`}
                    />
                    <div className="invalid-feedback">
                  ...
                  <div className="form-group col-md-6">
                    ...
                    <input
                      ...
                      className={`form-control ${errors && errors?.apartment?.area ? "is-invalid" : ""}`}
                    />
                    <div className="invalid-feedback">
                ...
                <div className="form-row">
                  ...
                  <div className="form-group col-md-6">
                    ...
                    <input
                      ...
                      className={`form-control ${errors && errors?.apartment?.room_count ? "is-invalid" : ""}`}
                    />
                    <div className="invalid-feedback">
                  ...
                  <div className="form-group col-md-6">
                    ...
                    <input
                      ...
                      className={`form-control ${errors && errors?.apartment?.bedroom_count ? "is-invalid" : ""}`}
                    />
                    <div className="invalid-feedback">
