      ...
      <div>
        <div className="container d-flex p-md-0">
          ...
          <div className="az-content-body pd-lg-l-40 d-flex flex-column">
            ...
            <p className="mg-b-20">
              Use align-self utilities on flexbox items to individually change their alignment on
              the cross axis.
            </p>
            ...
            <p className="mg-b-20">
              ...
              into widths equal to their content.
            </p>
