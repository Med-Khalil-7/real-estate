      ...
      <div>
        <div className="container d-flex p-md-0">
          ...
          <div className="az-content-body pd-lg-l-40 d-flex flex-column">
            ...
            <p className="mg-b-20">
              You can set a height to an element instantly by using the following utilities classes
              for height.
            </p>
            ...
            <p className="mg-b-0">
              You can also set a height to a different media query using the following utilities
              classes.
            </p>
