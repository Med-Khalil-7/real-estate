      ...
      <div>
        <div className="container d-flex p-md-0">
          ...
          <div className="az-content-body pd-lg-l-40 d-flex flex-column">
            ...
            <p className="mg-b-20">
              You can set opacity to an element instantly by using the following utilities classes
              for opacity.
            </p>
            ...
            <p className="mg-b-20">
              You can add or remove shadow to an element instantly by using the following utilities
              classes for shadow.
            </p>
            ...
            <div className="az-footer mg-t-auto">
              <div className="container">
                <span>&copy; 2021 THEHINA, data consulting services</span>
              </div>
              {/* container */}
            </div>
            {/* az-footer */}
