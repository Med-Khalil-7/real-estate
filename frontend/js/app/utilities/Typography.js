      ...
      <div>
        <div className="container d-flex p-md-0">
          ...
          <div className="az-content-body pd-lg-l-40 d-flex flex-column">
            ...
            <p className="mg-b-20">
              You can set a font size instantly to an element by using the following utilities
              classes.
            </p>
            ...
            <p className="mg-b-20">
              You can set a font weight instantly to an element by using the following utilities
              classes.
            </p>
            ...
            <p className="mg-b-20">
              You can set a font family instantly to an element by using the following utilities
              classes.
            </p>
            ...
            <p className="mg-b-20">
              You can set a font color instantly to an element by using the following utilities
              classes.
            </p>
              ...
              <table className="table az-table-reference mg-t-0">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      primary | success | warning | danger | info | indigo | purple | orange | teal
                      | pink | black | white | inverse
                    </td>
                  </tr>
                  <tr>
                    <td>
            ...
            <p className="mg-b-20">
              You can set a font spacing instantly to an element by using the following utilities
              classes.
            </p>
            ...
            <p className="mg-b-20">
              You can set a line height instantly to an element by using the following utilities
              classes.
            </p>
