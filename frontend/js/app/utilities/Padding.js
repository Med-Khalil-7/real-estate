      ...
      <div>
        <div className="container d-flex p-md-0">
          ...
          <div className="az-content-body pd-lg-l-40 d-flex flex-column">
            ...
            <p className="mg-b-20">
              You can set a padding to an element instantly by using the following utilities
              classes.
            </p>
            ...
            <p className="mg-b-20">
              You can also set a padding to a different media query using the following utilities
              classes.
            </p>
