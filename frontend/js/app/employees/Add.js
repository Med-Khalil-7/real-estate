...
import { GROUPS, DEPARTMENTS, EMPLOYEES } from "../../constants/api";
import api from "../../api";
...
export default function EmployeesAdd() {
  ...
  const validationSchema = Yup.object().shape({
    employee: Yup.object().shape({
      title: Yup.string().required("Employee title is required"),

      department: Yup.string().required("Employee department is required"),

      hire_date: Yup.date().required("Employee hiring date is required"),

      start_date: Yup.date()
        .required("Employee start date is required")
        .min(Yup.ref("hire_date"), "start date can't be before hiring date"),
    }),
  ...
  const loadData = async () => {
    ...
    try {
      ...
      if (id) {
        ...
        const fields = ["employee", "user", "gender"];
  ...
  const onSubmit = (data) => {
    if (id) {
      api
        ...
        .catch((e) => toast.error(`Failed to add employee ${e}`));
    } else {
      api
        .post(EMPLOYEES, data)
        .then((res) => {
  ...
  return (
    <div>
      <div className="page-header">
        <h3 className="page-title">{t("Employee management")}</h3>
          ...
          <div className="card">
            <div className="card-body">
              <h4 className="card-title">
                {id ? t("Employee edit") : t("Employee add")}
              </h4>
                ...
                <div className="form-row">
                  <div className="form-group col-md-6">
                    ...
                    <input
                      ...
                      className={`form-control ${
                        errors.user?.first_name ? "is-invalid" : ""
                      }`}
                    />
                  ...
                  <div className="form-group col-md-6">
                    ...
                    <input
                      ...
                      className={`form-control ${
                        errors.user?.last_name ? "is-invalid" : ""
                      }`}
                    />
                    <div className="invalid-feedback">
                ...
                <div className="form-row">
                  <div className="form-group col-md-4">
                    ...
                    <input
                      ...
                      className={`form-control ${
                        errors?.user?.address?.state ? "is-invalid" : ""
                      }`}
                    />
                    <div className="invalid-feedback">
                  ...
                  <div className="form-group col-md-4">
                    ...
                    <input
                      ...
                      className={`form-control ${
                        errors?.user?.address?.city ? "is-invalid" : ""
                      }`}
                    />
                    <div className="invalid-feedback">
