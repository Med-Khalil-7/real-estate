        ...
        <div className="row">
          ...
          <div className="col-md-6 grid-margin stretch-card">
            <div className="card">
              ...
              <div className="card-body">
                <p className="card-description">
                  Add className <code>.form-check-&#123;color&#123;</code> for checkbox and radio
          ...
          <div className="col-12 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                ...
                <p className="card-description">
                  {' '}
                  Use the <code>.form-inline</code> className to display a series of labels, form
                ...
                <form className="form-inline">
                  ...
                  <div className="form-check mx-sm-2">
                    <label className="form-check-label">
                      <input type="checkbox" className="form-check-input" defaultChecked /> Remember
                      me
                      <i className="input-helper"></i>
                    </label>
                  </div>
